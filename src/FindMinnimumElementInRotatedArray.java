...
public class FindMinnimumElementInRotatedArray {
    ...
    public static void main(String[] args) {
        ...
        FindMinnimumElementInRotatedArray s = new FindMinnimumElementInRotatedArray();
        System.out.println(s.findMin(arrayList));
    }
